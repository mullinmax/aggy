...
def get_rss_feed():
    try:
        rss_feed_url = 'https://rss-bridge.org/bridge01/?action=display&bridge=YoutubeBridge&context=By+custom+name&custom=%40TeslaDaily&duration_min=&duration_max=&format=Atom'
